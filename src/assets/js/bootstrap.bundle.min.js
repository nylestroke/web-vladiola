...
!(function (t, e) {
    ...
    at = (function () {
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if (
            ((o = t === M ? ((n = z), (i = X), U) : ((n = Y), (i = G), B)), l && p(l).hasClass(Q))
          )
            this._isSliding = !1;
  ...
  function Ft(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return 'BODY' === (a = (s = l).nodeName) || ('HTML' !== a && jt(s.firstElementChild) !== s)
        ? jt(l)
        : l;
    var c = Rt(t);
  ...
  var we = 'dropdown',
    ...
    Xe = (function () {
      ...
      return (
        ...
        (t.show = function () {
          if (
            !(this._element.disabled || p(this._element).hasClass(Oe) || p(this._menu).hasClass(Ne))
          ) {
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), p(this).data(Ce, t)),
              'string' == typeof e)
            ) {
        ...
        (c._clearMenus = function (t) {
          if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
            for (
              var e = [].slice.call(document.querySelectorAll(je)), n = 0, i = e.length;
              n < i;
              n++
            ) {
          ...
          if (
            (/input|textarea/i.test(t.target.tagName)
              ? !(
                  32 === t.which ||
                  (27 !== t.which &&
                    ((40 !== t.which && 38 !== t.which) || p(t.target).closest(Fe).length))
                )
              : Ie.test(t.which)) &&
        ...
        i = function (t, e) {
          ...
          o.forEach(function (t) {
            (function (t, e) {
              ...
              if (-1 !== e.indexOf(n))
                return (
                  -1 === _n.indexOf(n) || Boolean(t.nodeValue.match(yn) || t.nodeValue.match(En))
                );
              for (
      ...
      return (
        ...
        (t.setElementContent = function (t, e) {
          'object' != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ? (this.config.sanitize && (e = bn(e, this.config.whiteList, this.config.sanitizeFn)),
                t.html(e))
              : t.text(e)
            : this.config.html
      ...
      return (
        ...
        (n._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new n(this, 'object' == typeof e && e)), p(this).data(ri, t)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof t[e]) throw new TypeError('No method named "' + e + '"');
              t[e]();
    ...
    Wi = (function () {
      ...
      return (
        ...
        (t._activate = function (t, e, n) {
          var i = this,
            o = (
              !e || ('UL' !== e.nodeName && 'OL' !== e.nodeName) ? p(e).children(Hi) : p(e).find(ji)
            )[0],
