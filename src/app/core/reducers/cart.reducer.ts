...
import { ADD_TO_CART, REMOVE_FROM_CART, UPDATE_CART, REFRESH_STORE } from '../constants/constants';
...
export function cartReducer(state = getState('vio'), action) {
  switch (action.type) {
    case ADD_TO_CART:
      ...
      return {
        data: [
          ...state.data.filter((item) => {
            ...
            return item.html_title !== action.payload.product.html_title;
          }),
        ],
      };
